...
void UOTWDLobbyLocalState::OpenWeaponPartReward(const FOTWDWeaponPartSavedData& PartSavedData, const ESBZRewardType& RewardType, bool bNotify) {
}

void UOTWDLobbyLocalState::NotifyUpdatedStats() {
}

void UOTWDLobbyLocalState::NotifyOpenedRewards() {
}
