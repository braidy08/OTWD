...
void AOTWDLobbyBeaconClient::ServerUpdateOpenedRewards_Implementation(const FOTWDLobbyRewardsInfo& RewardInfo) {
}
bool AOTWDLobbyBeaconClient::ServerUpdateOpenedRewards_Validate(const FOTWDLobbyRewardsInfo& RewardInfo) {
    return true;
}
