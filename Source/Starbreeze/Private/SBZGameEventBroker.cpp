...
void USBZGameEventBroker::PostOnPassiveAbilityUpdated(APawn* Owner, ESBZPassiveAbilityState NewState) {
}

void USBZGameEventBroker::PostOnActorMarked(AActor* Actor, bool bIsMarked) {
}
