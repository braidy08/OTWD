...
void USBZSkyboundRegistrationAPI::RegisterUser(const FString& InUserEmail) {
}

void USBZSkyboundRegistrationAPI::LogOut() {
}

bool USBZSkyboundRegistrationAPI::IsValidEmail(const FString& InEmail) {
    return false;
}

bool USBZSkyboundRegistrationAPI::IsLoggedInToSkybound() {
    return false;
}
