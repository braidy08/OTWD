...
static struct FScriptStruct_ImmediatePhysics_StaticRegisterNativesFAnimNode_RigidBody
{
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_OverlapChannel = { UE4CodeGen_Private::EPropertyClass::Byte, "OverlapChannel", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_RigidBody, OverlapChannel), Z_Construct_UEnum_Engine_ECollisionChannel, METADATA_PARAMS(NewProp_OverlapChannel_MetaData, ARRAY_COUNT(NewProp_OverlapChannel_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_RigidBody_CRC() { return 4279570655U; }
