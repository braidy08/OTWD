...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMovieSceneAkAudioEventSection()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_MaxSourceDuration = { UE4CodeGen_Private::EPropertyClass::Float, "MaxSourceDuration", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000005, 1, nullptr, STRUCT_OFFSET(UMovieSceneAkAudioEventSection, MaxSourceDuration), METADATA_PARAMS(NewProp_MaxSourceDuration_MetaData, ARRAY_COUNT(NewProp_MaxSourceDuration_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_StopAtSectionEnd = { UE4CodeGen_Private::EPropertyClass::Bool, "StopAtSectionEnd", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMovieSceneAkAudioEventSection), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_StopAtSectionEnd_SetBit)>::SetBit, METADATA_PARAMS(NewProp_StopAtSectionEnd_MetaData, ARRAY_COUNT(NewProp_StopAtSectionEnd_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_RetriggerEvent = { UE4CodeGen_Private::EPropertyClass::Bool, "RetriggerEvent", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMovieSceneAkAudioEventSection), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_RetriggerEvent_SetBit)>::SetBit, METADATA_PARAMS(NewProp_RetriggerEvent_MetaData, ARRAY_COUNT(NewProp_RetriggerEvent_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieSceneAkAudioEventSection, 3350572660);
