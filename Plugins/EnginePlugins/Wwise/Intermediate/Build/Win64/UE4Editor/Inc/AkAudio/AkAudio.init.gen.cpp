	...
	UPackage* Z_Construct_UPackage__Script_AkAudio()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_AkOnCheckBoxComponentStateChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnBoolPropertyDropDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnWwiseItemDropDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemBoolPropertyDragDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemBoolPropertySelectionChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemPropertyDragDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemPropertySelectionChanged__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_AkOnFloatValueChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemDropDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnPropertyDropDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnEventCallback__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnWaapiConnectionLost__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnWaapiProjectLoaded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemDragDetected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AkAudio_OnItemSelectionChanged__DelegateSignature,
			};
